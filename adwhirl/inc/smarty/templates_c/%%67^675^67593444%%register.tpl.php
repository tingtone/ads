<?php /* Smarty version 2.6.26, created on 2011-08-26 08:42:42
         compiled from ../tpl/www/home/register.tpl */ ?>
<div id="content">
...
" />
              ...
              <p class="formElement required ">
                ...
                <input type="text" name="firstName" value="<?php echo $this->_tpl_vars['user']->firstName; ?>
" class="text"/>
              </p>
              <p class="formElement required ">
                <label for="lastName">Last:</label>
                <input type="text" name="lastName" value="<?php echo $this->_tpl_vars['user']->lastName; ?>
" class="text"/>
              </p>
              <p class="formElement required ">
