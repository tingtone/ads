<?php /* Smarty version 2.6.26, created on 2011-08-25 15:13:32
         compiled from ../tpl/www/home/new_home.tpl */ ?>
...
<div id="login">
  ...
  <form method="post" action="/home/login/login">
    ...
    <input id="submit" name="login" type="submit" class="button" value="Submit" tabindex="3" /><?php if ($this->_tpl_vars['invalidlogin']): ?><span class="error">&nbsp;&nbsp;Invalid login. Please try again.</span><?php endif; ?>
    <br />
