<?php /* Smarty version 2.6.26, created on 2011-08-26 08:44:34
         compiled from ../tpl/www/home/home.tpl */ ?>
...
<link href="old_css/style_home.css?nocache=1" rel="stylesheet" type="text/css" />
  ...
  <div id="topPan">
	...
	<ul>
		...
		<li><a href="http://groups.google.com/group/adwhirl-users?pli=1" target="_blank">Discuss</a></li>
	</ul>
    <h1><span></span></h1>
  </div>
  <!--Top Panel Close-->
  ...
  <h2>Log In</h2>
     <form id="form1" name="form1" method="post" action="/home/login/login">
     	<div class="errorMsg" id="errMsg" style="display:none">
		<b>Error:</b> Incorrect email/password combination
		</div>
	<label>Email Address:
<input name="email" type="text" id="email" onfocus="formInUse = true;" tabindex="1"/></label>
					<label>Password: <a href="/home/login/forgotPassword" style="font-size:12px;">(forgot password?)</a></label>
